...
interface SignInPassModalProps {
    openProp: boolean;
    onClose:any;
  }
  
const SignInPassModal: React.FC<SignInPassModalProps> = ({ openProp ,onClose}) => {
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        ...
                        Sign in With Password in order to login
                        </p>
                      </div>
                    </div>
                  </div>
...
export default SignInPassModal;
