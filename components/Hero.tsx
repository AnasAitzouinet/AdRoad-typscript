              ...
              <div className="mt-20">
                ...
                <div className="mt-6 sm:max-w-xl">
                  <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
                    Get your brand on the move with rideshare, gig economy
                    vehicles, and delivery robots.{" "}
                  </h1>
                  <p className="mt-6 text-xl text-gray-500">
                    Connect your offline advertising to the digital world and
            ...
            <div className="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
              ...
              <div className="relative -mr-40 pl-6 sm:mx-auto sm:max-w-3xl sm:px-0 lg:h-full lg:max-w-none lg:pl-12">
                <img
                  ...
                  src="https://www.nickelytics.com/wp-content/uploads/2022/07/Ponce-Law-12-1-759x1024.jpg"
                  alt=""
                />
              </div>
            </div>
